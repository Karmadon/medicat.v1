...
echo'<!-- SELECT2 EXAMPLE -->
	  <form role="form" method="POST" action="tmp/html/sprav/drop_wia/drop.php?id='.$id.'">
      <div class="box box-default">
        <div class="box-body">
		<div class="alert alert-danger alert-dismissible">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <h4><i class="icon fa fa-ban"></i> Внимание!</h4>
                Если Вы удалите элемент, то звонки и записи клиентов имеющие текущий элемент в поле "С каким вопросом обратились?", получат статус "Неизвестно"
              </div>
