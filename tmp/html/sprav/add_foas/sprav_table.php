<!-- SELECT2 EXAMPLE -->
	  <form role="form" method="POST" action="tmp/html/sprav/add_foas/new.php">
		  ...
		  <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Откуда узнали о нас" required>
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
