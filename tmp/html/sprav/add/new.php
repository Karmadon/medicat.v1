...
$sql = ("INSERT INTO sprav_client_group (id, name, day_repeat, dorr, torr, manager, color, nam_color) VALUES ('', '$name', '$day_repeat', '$dorr', '$torr', '$manager', '$color', '$nam_color')");
