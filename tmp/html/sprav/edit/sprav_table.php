...
echo'<!-- SELECT2 EXAMPLE -->
	  <form role="form" method="POST" action="tmp/html/sprav/edit/edit.php?id='.$id.'">
      <div class="box box-default">
		...
		<div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" value="'.$row["name"].'" placeholder="Укажите имя группы" required>
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                <label>Повтор, через кол-во дней</label>
                <input type="text" id="day" name="day" class="form-control" value="'.$row["day_repeat"].'" placeholder="Через сколько дней делать напоминание" required>
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
