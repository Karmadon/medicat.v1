...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Запись клиента: <?php require_once('ce_old_info.php'); ?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="/profile"><i class="fa fa-dashboard"></i> Главная</a></li>
        <li> <a href="/ce">Запись клиентов</a></li>
		<li class="active">Старая информация о записе</li>
      </ol>
    </section
    ...
    <section class="content">
      <!-- Info boxes -->
	  <?php require_once('ce_old_table.php'); ?>
    </section>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->