            ...
            <div class="box-header">
			  ...
			  <div class="box-tools pull-right">';
				if ($rowid["groupd_id"] =='1' || $rowid["groupd_id"] =='101') {
                                    echo'<a href="ce_edit?id='.$row["id"].'"" class="btn btn-box-tool btn-sm">Редактировать</a>';
				}
                                     echo'<a href="ce_status?id='.$row["id"].'" class="btn btn-box-tool btn-sm">Изменить статус</a>
                               </div>
            </div>
            <!-- /.box-header -->
              ...
              <table class="table table-hover">
                <tr>
                  ...
                  echo '<td><span class="label label-danger">Отменен</span></td>';
				   ...
				   elseif ($row["status"]=='3') {
                  echo '<td><span class="label label-info">Опаздывает</span></td>';
				  }
				  elseif ($row["status"]=='4') {
                  echo '<td><span class="label label-warning">Перенесен</span></td>';
				  }
				  else{}
				echo '</tr>
				<tr>
