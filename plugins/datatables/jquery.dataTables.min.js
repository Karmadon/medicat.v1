    ...
    var P = function(h) {
        ...
        function ob(a) {
            var b = a.oClasses,
                ...
                d = a.oPreviousSearch,
                f = a.aanFeatures,
                g = '<input type="search" class="input_datatable ' + b.sFilterInput + '"/>',
                j = e.sSearch,
                j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
                b = h("<div/>", {
                    id: !f.f ? c + "_filter" : null,
                    "class": b.sFilter
                }).append(h("<label class='label_datatable'/>").append(j)),
                f = function() {
        ...
        function nb(a) {
            for (var b = a.oClasses, c = a.sTableId, e = a.aLengthMenu, d = h.isArray(e[0]), f = d ? e[0] : e, e = d ? e[1] : e, d = h("<select/>", {
                    name: c + "_length",
                    "aria-controls": c,
                    "class": "select_datatable ' + b.sLengthSelect + '"
                }), g = 0, j = f.length; g < j; g++) d[0][g] = new Option(e[g],
                f[g]);
            var i = h("<div><label class='label_datatable'/></div>").addClass(b.sLength);
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "Отображено с _START_ по _END_ из <b>_TOTAL_ записей</b>",
                sInfoEmpty: "Отображено 0 записей",
                sInfoFiltered: "(filtered from _MAX_ total entries)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "<div class='search_datatable'>Количество записей на странице</div> _MENU_",
                sLoadingRecords: "Loading...",
                sProcessing: "Processing...",
                sSearch: "<div class='search_datatable'>Поиск:</div>",
                sSearchPlaceholder: "",
                sUrl: "",
                sZeroRecords: "<span class='text-red'>По Вашему запросу ничего не найдено</span>"
            },
